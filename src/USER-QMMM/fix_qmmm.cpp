...
*/
  ...
  if (qmmm_role == QMMM_ROLE_MASTER) {
    //TODO: should this be in exchange_forces?!
    ...
    if (comm->me == 0) {
      //TODO: was kostet der alloc im vgl zum blockierten speicher?
      ...
      // TODO: wie sind die daten verteilt? muss sammeln here.
      // sonst nix parallel MM
