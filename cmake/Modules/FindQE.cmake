...
set(QE_CP_DIR ${QE_COUPLE_DIR}/../../CPV/src)
find_library(QE_CP_LIBRARY NAMES cp HINTS ${QE_CP_DIR})
...
set(QE_LIBRARIES ${QE_COUPLE_LIBRARY} ${QE_MOD_LIBRARY} ${QE_FFT_LIBRARY} ${QE_IOTK_LIBRARY})
...
set(QE_INCLUDE_DIRS ${QE_COUPLE_DIR} ${QE_MOD_DIR} ${QE_FFT_DIR} ${QE_LAX_DIR} ${QE_CLIB_DIR} ${QE_IOTK_DIR} ${QE_UTIL_DIR} ${QE_MOD_DIR})
...
find_package_handle_standard_args(QE DEFAULT_MSG QE_COUPLE_LIBRARY QE_CP_LIBRARY QE_PW_LIBRARY QE_MOD_LIBRARY QE_FFT_LIBRARY QE_LA_LIBRARY QE_CLIB_LIBRARY QE_IOTK_LIBRARY QE_UTIL_LIBRARY QE_COUPLE_DIR)
